...
class AIOrchestrator:
    ...
    def __init__(self, api_key: str = ""):
        ...
        self.karma_assessor = KarmaAssessor(api_key=api_key, game_type="weiqi")
...
请分析并输出JSON。"""
    ...
    def _get_board_summary(self, board: dict) -> str:
        ...
        return f"黑方{black_count}子, 白方{white_count}子"
        ...
        if action_name == "undo_move":
            ...
            for _ in range(steps):
                if not history:
                    break
                last = history.pop()
                # 围棋：落子制，from 为 None，需要将落下的子标记为已死
